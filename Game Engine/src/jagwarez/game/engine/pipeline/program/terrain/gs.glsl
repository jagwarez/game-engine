...
void main(void) {
  ...
  vec2 p0 = viewport * gl_in[0].gl_Position.xy / gl_in[0].gl_Position.w;
  vec2 p1 = viewport * gl_in[1].gl_Position.xy / gl_in[1].gl_Position.w;
  vec2 p2 = viewport * gl_in[2].gl_Position.xy / gl_in[2].gl_Position.w;
